...
const phases = [
    {
        ...
        text: 'smart contract development with solidity 0.8.24 and openzeppelin. hardhat setup for multi-chain deployment, testing, and gas optimization. core governance logic and ERC20 voting token implementation.',
        timeline: 'complete',
    },
    {
    ...
    },
    {
        ...
        text: 'live results panel with socket.io streaming, admin dashboard for proposal management, enterprise pilot deployments, and cross-chain governance expansion for multi-entity corporate structures.',
        timeline: 'upcoming',
    },
]
