...
const features = [
    {
        id: 'governance',
        title: 'KWOTE smart contract',
        description:
            'the central engine of kwote — a solidity 0.8.24 smart contract using openzeppelin standards for ERC20 voting power and KWOTE logic. manages proposal creation, voting periods, quorum enforcement, and automated tallying.',
    },
    {
        id: 'pwa',
